  ...
  return (
    <section className="relative isolate overflow-hidden">
      <div className="pointer-events-none absolute inset-0 -z-10">
        ...
        />
        <div
          className="absolute right-[8%] top-[10%] h-[13rem] w-[13rem] bg-[url('/brand/logo-symbol-cyan.png')] bg-contain bg-center bg-no-repeat opacity-[0.08] blur-[0.4px] saturate-[1.05] [mask-image:radial-gradient(circle_at_center,black_42%,transparent_88%)]"
          aria-hidden="true"
        />
        ...
        <motion.svg
          className="absolute right-[11%] top-[16%] h-40 w-40 opacity-[0.14] [mask-image:radial-gradient(circle_at_center,black_52%,transparent_92%)]"
          viewBox="0 0 100 100"
          fill="none"
          aria-hidden="true"
          animate={{ y: [0, 6, 0], opacity: [0.1, 0.16, 0.1] }}
          transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }}
        >
          <path d="M28 28 H72 V72 H28 Z" stroke="rgba(0,214,255,0.42)" strokeWidth="1.5" />
          <circle cx="28" cy="28" r="3.2" fill="rgba(0,214,255,0.88)" />
          <circle cx="72" cy="28" r="3.2" fill="rgba(0,214,255,0.88)" />
          <circle cx="72" cy="72" r="3.2" fill="rgba(0,214,255,0.88)" />
          <circle cx="28" cy="72" r="3.2" fill="rgba(0,214,255,0.88)" />
        </motion.svg>
      </div>
        ...
        <div className="grid items-start gap-10 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:gap-12">
          <MotionWrapper className="space-y-7">
            ...
            <div className="flex flex-wrap gap-3 pt-1">
              <Button asChild size="lg" className="border border-primary/30 bg-primary/90 px-8 font-semibold tracking-[0.02em] text-primary-foreground shadow-[0_10px_24px_rgba(2,10,24,0.28)] transition-all duration-300 hover:-translate-y-0.5 hover:border-primary/50 hover:bg-primary hover:shadow-[0_14px_30px_rgba(2,10,24,0.34)]">
